...
{
    array temp;
    temp.ar[0][0] = a1.ar[0][0] + a2.ar[0][0];
    temp.ar[0][1] = a1.ar[0][1] + a2.ar[0][1];
    temp.ar[0][2] = a1.ar[0][2] + a2.ar[0][2];
    temp.ar[1][0] = a1.ar[1][0] + a2.ar[1][0];
    temp.ar[1][1] = a1.ar[1][1] + a2.ar[1][1];
    temp.ar[1][2] = a1.ar[1][2] + a2.ar[1][2];
    return temp;
}
